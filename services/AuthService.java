...
/**
 * Basic authentication service (in-memory) that associates a username with an employee and verifies passwords.
 */
public class AuthService {
    ...
    /**
     * Registers a new employee in the authentication system (assign username & password).
     */
